...
declare const BatchDescribeModelPackageCommand_base: {
    new (input: BatchDescribeModelPackageCommandInput): import("@smithy/core/client").CommandImpl<BatchDescribeModelPackageCommandInput, BatchDescribeModelPackageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchDescribeModelPackageCommandInput): import("@smithy/core/client").CommandImpl<BatchDescribeModelPackageCommandInput, BatchDescribeModelPackageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
