...
declare const CreateInferenceComponentCommand_base: {
    new (input: CreateInferenceComponentCommandInput): import("@smithy/core/client").CommandImpl<CreateInferenceComponentCommandInput, CreateInferenceComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateInferenceComponentCommandInput): import("@smithy/core/client").CommandImpl<CreateInferenceComponentCommandInput, CreateInferenceComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
