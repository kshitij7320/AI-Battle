...
declare const DescribeModelPackageCommand_base: {
    new (input: DescribeModelPackageCommandInput): import("@smithy/core/client").CommandImpl<DescribeModelPackageCommandInput, DescribeModelPackageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeModelPackageCommandInput): import("@smithy/core/client").CommandImpl<DescribeModelPackageCommandInput, DescribeModelPackageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
