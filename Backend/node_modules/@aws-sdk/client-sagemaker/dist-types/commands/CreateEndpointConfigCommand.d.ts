...
declare const CreateEndpointConfigCommand_base: {
    new (input: CreateEndpointConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateEndpointConfigCommandInput, CreateEndpointConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateEndpointConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateEndpointConfigCommandInput, CreateEndpointConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
