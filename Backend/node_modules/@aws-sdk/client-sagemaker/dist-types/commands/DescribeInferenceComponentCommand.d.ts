...
declare const DescribeInferenceComponentCommand_base: {
    new (input: DescribeInferenceComponentCommandInput): import("@smithy/core/client").CommandImpl<DescribeInferenceComponentCommandInput, DescribeInferenceComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeInferenceComponentCommandInput): import("@smithy/core/client").CommandImpl<DescribeInferenceComponentCommandInput, DescribeInferenceComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
