...
declare const UpdateModelPackageCommand_base: {
    new (input: UpdateModelPackageCommandInput): import("@smithy/core/client").CommandImpl<UpdateModelPackageCommandInput, UpdateModelPackageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateModelPackageCommandInput): import("@smithy/core/client").CommandImpl<UpdateModelPackageCommandInput, UpdateModelPackageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
