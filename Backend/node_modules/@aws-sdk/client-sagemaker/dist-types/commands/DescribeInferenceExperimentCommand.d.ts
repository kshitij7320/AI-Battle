...
declare const DescribeInferenceExperimentCommand_base: {
    new (input: DescribeInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<DescribeInferenceExperimentCommandInput, DescribeInferenceExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<DescribeInferenceExperimentCommandInput, DescribeInferenceExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
