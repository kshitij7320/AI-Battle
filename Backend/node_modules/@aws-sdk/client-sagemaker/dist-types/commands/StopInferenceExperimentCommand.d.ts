...
declare const StopInferenceExperimentCommand_base: {
    new (input: StopInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<StopInferenceExperimentCommandInput, StopInferenceExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<StopInferenceExperimentCommandInput, StopInferenceExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
