...
declare const DescribeEndpointConfigCommand_base: {
    new (input: DescribeEndpointConfigCommandInput): import("@smithy/core/client").CommandImpl<DescribeEndpointConfigCommandInput, DescribeEndpointConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeEndpointConfigCommandInput): import("@smithy/core/client").CommandImpl<DescribeEndpointConfigCommandInput, DescribeEndpointConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
