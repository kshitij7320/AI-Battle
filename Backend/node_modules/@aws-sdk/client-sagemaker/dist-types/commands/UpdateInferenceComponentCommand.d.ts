...
declare const UpdateInferenceComponentCommand_base: {
    new (input: UpdateInferenceComponentCommandInput): import("@smithy/core/client").CommandImpl<UpdateInferenceComponentCommandInput, UpdateInferenceComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateInferenceComponentCommandInput): import("@smithy/core/client").CommandImpl<UpdateInferenceComponentCommandInput, UpdateInferenceComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
