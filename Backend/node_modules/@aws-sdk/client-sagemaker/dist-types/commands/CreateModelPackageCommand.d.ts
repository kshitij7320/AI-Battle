...
declare const CreateModelPackageCommand_base: {
    new (input: CreateModelPackageCommandInput): import("@smithy/core/client").CommandImpl<CreateModelPackageCommandInput, CreateModelPackageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateModelPackageCommandInput]): import("@smithy/core/client").CommandImpl<CreateModelPackageCommandInput, CreateModelPackageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
