...
declare const UpdateInferenceExperimentCommand_base: {
    new (input: UpdateInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<UpdateInferenceExperimentCommandInput, UpdateInferenceExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<UpdateInferenceExperimentCommandInput, UpdateInferenceExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
