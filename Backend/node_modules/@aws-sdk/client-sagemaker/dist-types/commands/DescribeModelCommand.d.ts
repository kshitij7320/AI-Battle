...
declare const DescribeModelCommand_base: {
    new (input: DescribeModelCommandInput): import("@smithy/core/client").CommandImpl<DescribeModelCommandInput, DescribeModelCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeModelCommandInput): import("@smithy/core/client").CommandImpl<DescribeModelCommandInput, DescribeModelCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
